...
function Section2() {
  return (
    <section className="xs:px-5 md:px-0 md:py-16">
      <div className="bg-neutrals-3 rounded-3xl px-4 py-8 md:px-0 md:pb-32 md:pt-0">
        ...
        <div className="relative mx-auto mt-6 grid w-11/12 gap-5 text-left md:h-16 md:grid-cols-3 md:gap-4">
          {reviews.map((review, i) => (
            <div
              key={i}
              className="mx-auto max-w-[352px] rounded-3xl bg-darkNavy px-6 py-8 md:px-10 md:py-10"
            >
